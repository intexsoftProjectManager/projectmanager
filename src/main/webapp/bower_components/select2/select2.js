...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        ensureHighlightVisible: function () {
            ...
            hb = child.length > 0 ? child.offset().top : 0 + child.outerHeight(true);
            ...
            y = child.length > 0 ? child.offset().top : 0 - results.offset().top;

            // make sure the top of the element is visible
            if (child.length > 0 && y < 0 && child.css('display') != 'none' ) {
