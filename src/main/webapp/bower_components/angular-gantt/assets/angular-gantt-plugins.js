...
(function(){
    'use strict';
    angular.module('gantt.drawtask', ['gantt']).directive('ganttDrawTask', ['ganttMouseOffset', 'moment', 'ganttUtils', function(mouseOffset, moment, utils) {
        return {
            restrict: 'E',
            require: '^gantt',
            scope: {
                ...
                api.directives.on.new(scope, function(directiveName, directiveScope, element) {
                    if (directiveName === 'ganttRow') {
                        var drawHandler = function(evt) {
                            ...
                            var enabled = utils.firstProperty([directiveScope.row.model.drawTask], 'enabled', scope.enabled);
