...
.directive('mbScrollbar', function($rootScope) {
    return {
        restrict: 'A',
        transclude: true,
        scope: {
        ...
        link: function(scope, element) {
            ...
            function scrollTo(position) {
                ...
                var newPosition = pct * containerSize + config.scrollbar.margin;
                scrollbar.css(config.position, newPosition + 'px');
            ...
            child.on('mousewheel', function(event) {
                $rootScope.$emit('mbScrollbar:scroll');
