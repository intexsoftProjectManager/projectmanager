...
(function(){ // encapsulate all variables so they don't become global vars
	...
	*/
	...
	if(ie > 8 || ie === undefined){
		...
		_addCSSRule(topsheet, '.ta-scroll-window.form-control', "height: auto; min-height: 200px; overflow: auto; font-family: inherit; font-size: 100%; position: relative; padding: 0;");
		...
		_addCSSRule(topsheet, '.ta-editor.ta-html', "min-height: 200px; height: auto; overflow: auto; font-family: inherit; font-size: 100%;");
		_addCSSRule(topsheet, '.ta-scroll-window > .ta-bind', "height: auto; min-height: 200px; padding: 6px 12px;");
