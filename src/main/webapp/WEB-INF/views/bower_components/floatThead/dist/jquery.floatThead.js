...
(function( $ ) {
  ...
  $.fn.floatThead = function(map){
    ...
    this.filter(':not(.'+opts.floatTableClass+')').each(function(){
      ...
      //var layoutAuto = {'table-layout': 'fixed'};
      ...
      function setHeaderHeight(){
        ...
        $sizerRow.outerHeight(headerHeight + 2);
        $sizerCells.outerHeight(headerHeight + 2);
      }
      ...
      function columnNum(){
        ...
        if(existingColGroup){
          ...
          $headerColumns = $header.find('tr:first>th');
          count = 0;
          ...
          return function () {
            ...
            if ($rowCells.length == numCols && numCols > 0) {
              ...
              for (i = 0; i < numCols; i++) {
                ...
                //change to computedstyle
                var rowWidth = window.getComputedStyle(_rowcell,null).width;
                //_rowcell.offsetWidth;
